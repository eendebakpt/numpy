        ...
        npy_bool outer)
{
    ...
    if (out_is_passed_by_position) {
        ...
        if (all_none) {
            multi_DECREF(ufunc_output, nout_args);
            ufunc_output = NULL;
            nout_args = 0;
        }
    }
...
ufunc_at(PyUFuncObject *ufunc, PyObject *args)
{
    ...
    PyArrayMethodObject *ufuncimpl = NULL;
    {
        ...
        PyObject *resolve_inputs_storage[2];
        PyObject *const *resolve_inputs = NULL;
        if (op2_is_pyscalar || op2_is_pystr) {
            resolve_inputs_storage[0] = op1;
            resolve_inputs_storage[1] = op2;
            resolve_inputs = resolve_inputs_storage;
        }
        ...
        if (ufuncimpl != NULL) {
            ...
            resolve_result = resolve_descriptors(nop, ufunc, ufuncimpl,
                    ...
                    resolve_inputs, NPY_UNSAFE_CASTING);
        }
        if (op2_array != NULL) {
