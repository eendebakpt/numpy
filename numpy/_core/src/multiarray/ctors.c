...
{
    /*
     * Fast path: when op is already an ndarray and no dtype/flags/depth
     * constraints are given, just return it directly.  This avoids the
     * expensive DiscoverDTypeAndShape → CanCastArrayTo pipeline.
     */
