...
assert_type(np.dtype(py_object), np.dtype[np.object_[_PyObjectLike]])
assert_type(np.dtype(str), np.dtype[np.str_])
assert_type(np.dtype(bytes), np.dtype[np.bytes_])
...
# object types
assert_type(np.dtype(list), np.dtype[np.object_[list[Any]]])
assert_type(np.dtype(dt.datetime), np.dtype[np.object_[dt.datetime]])
assert_type(np.dtype(dt.timedelta), np.dtype[np.object_[dt.timedelta]])
assert_type(np.dtype(Decimal), np.dtype[np.object_[Decimal]])
assert_type(np.dtype(Fraction), np.dtype[np.object_[Fraction]])
